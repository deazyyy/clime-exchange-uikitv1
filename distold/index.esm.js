...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, { className: "menutoplogo" }, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Pancake home page" },
        React.createElement("img", { src: "images/clime/logo.png", alt: "piano", className: "logoimg" }),
        React.createElement("img", { src: "images/clime/logo-mobile.png", alt: "piano", className: "logomobileimg" }))) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Pancake home page" },
        React.createElement("img", { src: "images/clime/logo.png", alt: "piano", className: "logoimg" }),
        React.createElement("img", { src: "images/clime/logo-mobile.png", alt: "piano", className: "logomobileimg" })))));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        React.createElement("img", { width: "160", height: "51", src: isDark ? 'images/clime/logo.png' : 'images/clime/logo.png', alt: "navimg", className: "navlogo" }),
        ...
        React.createElement(SettingsEntry, null,
            React.createElement(SocialEntry, { style: { display: "flex", justifyContent: "center" } }, (cakePriceUsd && violaPriceUsd) ? (React.createElement(PriceLink, null,
                React.createElement("div", { className: "priceouter" },
                    React.createElement("img", { src: "images/clime/heart.png", alt: "piano", className: "heartimg" }),
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss, className: "modalwallet" },
        React.createElement("img", { src: "images/clime/userimg.png", alt: "user", className: "useridimg" }),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", { className: "connectBtn" }, account ? (React.createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        React.createElement("img", { src: "images/clime/face.png", alt: "connect" }),
            ...
            React.createElement("div", { className: "menutopdeskinner" },
                ...
                React.createElement("div", { className: "menuconntouter" },
                    ...
                    React.createElement("div", { className: "connectrowouter" },
                        React.createElement("a", { href: "#", className: "nav_link outlineBtn" }, "Exchange"),
