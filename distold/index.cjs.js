...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { className: "menutoplogo" }, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Pancake home page" },
        React__default['default'].createElement("img", { src: "images/clime/logo.png", alt: "piano", className: "logoimg" }),
        React__default['default'].createElement("img", { src: "images/clime/logo-mobile.png", alt: "piano", className: "logomobileimg" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Pancake home page" },
        React__default['default'].createElement("img", { src: "images/clime/logo.png", alt: "piano", className: "logoimg" }),
        React__default['default'].createElement("img", { src: "images/clime/logo-mobile.png", alt: "piano", className: "logomobileimg" })))));
};
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement("img", { width: "160", height: "51", src: isDark ? 'images/clime/logo.png' : 'images/clime/logo.png', alt: "navimg", className: "navlogo" }),
        ...
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(SocialEntry, { style: { display: "flex", justifyContent: "center" } }, (cakePriceUsd && violaPriceUsd) ? (React__default['default'].createElement(PriceLink, null,
                React__default['default'].createElement("div", { className: "priceouter" },
                    React__default['default'].createElement("img", { src: "images/clime/heart.png", alt: "piano", className: "heartimg" }),
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss, className: "modalwallet" },
        React__default['default'].createElement("img", { src: "images/clime/userimg.png", alt: "user", className: "useridimg" }),
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: "connectBtn" }, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        React__default['default'].createElement("img", { src: "images/clime/face.png", alt: "connect" }),
        ...
        React__default['default'].createElement(StyledNav, { showMenu: showMenu, className: "menutopdesk" },
            React__default['default'].createElement("div", { className: "menutopdeskinner" },
                React__default['default'].createElement("div", { className: "logoleft" },
                    React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: "#" })),
                React__default['default'].createElement("div", { className: "menuconntouter" },
                    ...
                    React__default['default'].createElement("div", { className: "connectrowouter" },
                        React__default['default'].createElement("a", { href: "#", className: "nav_link outlineBtn" }, "Exchange"),
